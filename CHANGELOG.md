...
### Changed
- Bumped the bundled minimal workspace's `dlthub-client` 0.28.3 → 0.28.4, pulling in its new `regex` transitive.

## [0.2.9] - 2026-09-09

### Added
- The bundled minimal workspace now ships a `.mcp.json` registering the dlt workspace MCP server.
